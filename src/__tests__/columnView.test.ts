      ...
      panes: [
        {
          ...
          basePath: '/Users',
          files: [
            { name: 'john', path: '/Users/john', isDirectory: true, size: 0, modified: new Date().toISOString(), extension: '' },
            { name: 'jane', path: '/Users/jane', isDirectory: true, size: 0, modified: new Date().toISOString(), extension: '' },
            { name: 'shared', path: '/Users/shared', isDirectory: true, size: 0, modified: new Date().toISOString(), extension: '' },
          ],
          loading: false,
          error: null,
