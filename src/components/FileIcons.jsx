...
// Convenience: renders all icons in a grid for preview
export function FileIconGrid({ size = 40, showLabel = true }) {
  const allExts = Object.keys(iconDefs).filter((k) => !iconDefs[k].alias);
