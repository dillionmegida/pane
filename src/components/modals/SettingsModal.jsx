      ...
      <ResizableModalBox width="480px" onClick={e => e.stopPropagation()}>
        ...
        <ModalBody>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                    <div style={{ 
                      ...
                      height: 16, 
                      borderRadius: '50%', 
                      background: themeObj.bg.primary,
                      border: `2px solid ${themeObj.border.normal}`,
                    }} />
                  ...
                  <div style={{ display: 'flex', gap: 3 }}>
                    {themeObj.tagColors.slice(0, 6).map((color, i) => (
          ...
          <div style={{ background: theme.bg.secondary, border: `1px solid ${theme.border.normal}`, borderRadius: theme.radius.md, padding: 12, fontSize: 11, color: theme.text.tertiary }}>
            <div style={{ color: theme.text.secondary, fontWeight: 600, marginBottom: 6 }}>About Finder Pro</div>
